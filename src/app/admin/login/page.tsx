    ...
    <div className="min-h-screen bg-[#e6dec8] flex items-center justify-center p-4">
      <div className="w-full max-w-sm">
        <div className="text-center mb-8">
          <div className="inline-flex items-center justify-center w-20 h-20 rounded-2xl bg-[#eee7d4] border-2 border-[#da5a47] mb-4">
            <span className="text-2xl font-bold text-[#da5a47]">M&M</span>
          </div>
